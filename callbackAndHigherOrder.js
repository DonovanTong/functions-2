...
// CODE HERE
const multiply = (num1, num2, callbackMult) => callbackMult(num1*num2)
...
// CODE HERE 
const first = (arr2, callback2) => callback2(arr2[0])
...
// CODE HERE 
function contains(arr, named, callback) {
    return callback(arr.includes(named))
...
// CODE HERE 
const getUserById = (obj, id, callback) => {
